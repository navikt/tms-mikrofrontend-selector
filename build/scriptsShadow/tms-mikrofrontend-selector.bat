...
set CLASSPATH=%APP_HOME%\lib\tms-mikrofrontend-selector-all.jar

@rem Execute tms-mikrofrontend-selector
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TMS_MIKROFRONTEND_SELECTOR_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
